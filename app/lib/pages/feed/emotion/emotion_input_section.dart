...
class _EmotionInputSection extends StatefulWidget {
  const _EmotionInputSection();

  @override
  State<_EmotionInputSection> createState() => _EmotionInputSectionState();
}

class _EmotionInputSectionState extends State<_EmotionInputSection> {
